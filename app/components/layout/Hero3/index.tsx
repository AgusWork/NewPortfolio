  ...
  return (
    <div className={`${theme === "dark" ? "dark" : ""} h-screen`}>
      <div className="bg-background h-full text-foreground transition-colors duration-300 dark:bg-background-dark dark:text-foreground-dark">
        ...
        <section className="container mx-auto px-4 py-[5vh] w-full h-[85vh]">
          <motion.div
            className="flex flex-col lg:flex-row w-full h-full md:h-[60vh] p-7 md:p-10 bg-gradient-to-br from-teal-50 to-sky-50 dark:from-teal-900 dark:to-sky-900 rounded-3xl shadow-xl"
            {...boxAnimation}
          >
            <div className="flex flex-col flex-grow">
              <motion.div {...fadeIn} className="max-w-4xl">
                ...
                <motion.p
                  {...fadeIn}
                  className="mt-6 text-md md:text-xl text-muted-foreground"
                >
                  I design visually captivating and highly intuitive websites
                  that empower businesses to stand out and engage their audience
                  effectively.
                </motion.p>
              </motion.div>
              <motion.div
