  ...
  return (
    <Link href={project.link} className="h-[70vh] w-full flex flex-col">
      ...
      <div className="flex flex-col w-full h-[25%] justify-center">
        <h3 className={`${playFair.className} text-2xl mb-2 font-semibold`}>
          {project.title}
        </h3>
...
const RelatedProjects: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const selectedProjects = shuffleArray(projectsData.projects)
      .slice(0, 2)
      .map((item: Project) => ({
        title: item.client,
  ...
  return (
    <GralLayout>
      <div className="mx-auto flex items-center justify-center text-center mb-[10vh]">
        <div
